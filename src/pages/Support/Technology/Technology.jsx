...
const technologies = [
  {
    ...
    source: 'Audio credit: City of Charlotte',
    imageCredit: 'Image credit: City of Charlotte'
  },
  {
    id: 2,
    ...
    source: 'Video credit: The Blind Life',
    imageCredit: 'Image credit: U.S. Access Board'
  },
  {
    id: 3,
    ...
    source: 'Audio credit: Khadija Bari',
    imageCredit: 'Image credit: Perkins School for the Bind'
  },
  {
    id: 4,
    title: 'JAWS',
    ...
    source: 'Video credit: Sight & Sound Technology Limited',
    imageCredit: 'Image credit: JAWS®'
  },
  {
    id: 5,
    title: 'Be My AI',
    ...
    source: 'Audio credit: Khadija Bari',
    imageCredit: 'Image credit: Be My Eyes'
  },
  {
    id: 6,
    title: 'Be My Eyes',
  ...
  },
  {
    ...
    source:'Video credit: aisquared',
    imageCredit: 'Image credit: Fusion™'
  },
  {
    id: 8,
    ...
    source: 'Audio credit: Khadija Bari',
    imageCredit: 'Image credit: Film & Disability'
  },
  {
    id: 9,
    title: 'OKO',
  ...
  },
  {
    ...
    source: 'Video credit: Irie AT Inc.',
    imageCredit: 'Image credit: Georgia Institute of Technology'
  },
  {
    id: 11,
    title: 'Bookshare',
    ...
    imageCredit: 'Image credit: Support for Families of Children with Disabilities'
  },
  {
    id: 12,
    ...
    imageCredit: 'Image credit: @Tony-duke'
  },
];
        ...
        <div className="technology-cards">
          {technologies.map((tech) => (
            <div key={tech.id} className="technology-card">
              ...
              <p className="image-credit">{tech.imageCredit}</p> {/* 添加这一行 */}
              <h2>{tech.title}</h2>
